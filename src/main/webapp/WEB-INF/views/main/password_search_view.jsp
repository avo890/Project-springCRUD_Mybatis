			...
			<div class="input-form col-md-12 mx-auto">
				<fieldset>
					...
					<div class="row pb-1 justify-content-center">
						...
						<div class="row pb-1 justify-content-center">[검색한 비밀번호의 정보]</div>
					</div>
					...
					<c:choose>
						<c:when test="${!empty searchPassword.password}">
							<div class="row pb-1 justify-content-center">

								찾으시는 비밀번호는 <b class="text-danger">${searchPassword.password}</b>
								입니다.<br>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<br>
						<button id="large" onclick="location.href='./SearchId'">아이디
							찾기</button>
					</div>
					<div class="col-md-4">
						<br>
