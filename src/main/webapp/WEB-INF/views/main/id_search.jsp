			...
			<div class="input-form col-md-12 mx-auto">
				<fieldset>
					...
					<legend> &nbsp;&nbsp;아이디 찾기</legend>
						...
						<form action="./SearchId" method="post" id="signupForm"
							enctype="application/x-www-form-urlencoded">

							<div class="form-group">
								<label for="name"></label>
								<input type="text" name="name" id="name" class="form-control"
									placeholder="등록하신 이름을 정확히 입력하세요."> <label for="phoneNum"></label> <input
									type="text" name="phoneNum" id="phoneNum" class="form-control"
									placeholder="등록하신 핸드폰번호를 '-'없이 11자리 입력하세요.">
							</div>
							<button type="submit" id="large">아이디 찾기</button>
						</form>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<br>
						<button id="large"
							onclick="location.href='./SearchPassword'">비밀번호
							찾기</button>
					</div>
					<div class="col-md-4">
						<br>
